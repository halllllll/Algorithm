...
- 適当に毎回更新する。いま出てる色の種類の数（それまで出た0の数で適当にインクリメントするなど）してかけていき、最終的にどの数列のルートにどの色を割り当てるかをしてやる。
  ...
  - 卑怯過ぎる
- 判明。先頭が0じゃないのもあるが、**0が4回以上登場する**という邪悪すぎるパターンがあるらしい。これ問題文から読み取れるのって解説の解法がさっと頭に浮かんだ人限定じゃないか？？？ちょっと愚直に考えてから実装してやり直してを繰り返した自分のような解答だとそもそもたどりつくの相当性格がねじまがってないと無理では...