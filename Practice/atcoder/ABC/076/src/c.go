...
// * AC後メモ
// 		- すげぇ雑に書いたので通るかどうかわからんかった
//		- golangでstring型がlenできるかとか、後ろから見てるiやら前から見てるjやらkやらの扱いがフットーしそう
//		- iより左側の?だけを考えていた（pre）ので、書いたあとにi+len(t)より右側の?を無視してたのを思い出して、雑にコピペして貼っただけのepiを用意した
//		- いや〜雑すぎる つーかgoでstringするのいちいちだるいな
package main
